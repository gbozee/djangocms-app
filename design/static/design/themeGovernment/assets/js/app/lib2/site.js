...
appMakeBeCool.Site = function ($, window, document, undefined) {
    ...
    _site.init = function (options) {
        ...
        _options.onComplete();
        $window.trigger('siteInitComplete', {
            options: _options
        });
    ...
    _site.getSiteMode = function () {
        ...
        siteMode.push({
            classObject: _site.globals.siteMode,
            classExtends: 'SiteMode'
        });
    ...
    site.init = function () {
        ...
        if (!$.fn.findAndSelf) $.fn.findAndSelf = function (selector) {
    ...
    site.base.Class.prototype = {
        ...
        classDependentsStatus: function () {
            ...
            $.each(_baseClass.properties.classDependents, function (i) {
                if (!_baseClass.globals.classDependentsInstances[i].globals.setupComplete) _ret = $.extend(_ret, {
                    setupComplete: false
                });
                if (!_baseClass.globals.classDependentsInstances[i].globals.loadComplete) _ret = $.extend(_ret, {
                    loadComplete: false
                });
            });
            return _ret;
        ...
        createComplete: function (fn) {
            ...
            var _fn = function () {
                ...
                $window.trigger('classCreateComplete', {
        ...
        destroyStart: function (fn) {
            _baseClass = this;
            this.trigger('classDestroyStart', {
                classId: _baseClass.properties.classId,
                classType: _baseClass.globals.classType
            });
            if (typeof fn === 'function') fn();
        ...
        destroyComplete: function (fn) {
            ...
            var _fn = function () {
                ...
                _baseClass.trigger('classDestroyComplete', {
                    classId: _baseClass.properties.classId,
                    classType: _baseClass.globals.classType
                });
            };
